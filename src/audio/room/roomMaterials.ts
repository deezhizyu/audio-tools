...
export const ROOM_MATERIALS: readonly RoomMaterial[] = [
  ...
  { id: 'concrete', label: 'Concrete', absorption: { low: 0.01, mid: 0.02, high: 0.02 }, scatterAmount: 0.7, color: '#9a9a94' },
  { id: 'painted-brick', label: 'Painted brick', absorption: { low: 0.01, mid: 0.02, high: 0.02 }, scatterAmount: 0.6, color: '#a6432e' },
  { id: 'bare-brick', label: 'Unpainted brick', absorption: { low: 0.03, mid: 0.03, high: 0.05 }, scatterAmount: 0.75, color: '#b1553a' },
  { id: 'linoleum', label: 'Linoleum', absorption: { low: 0.02, mid: 0.03, high: 0.02 }, scatterAmount: 0.15, color: '#c9b896' },
  { id: 'parquet', label: 'Parquet', absorption: { low: 0.04, mid: 0.07, high: 0.06 }, scatterAmount: 0.35, color: '#b8874c' },
  { id: 'wood', label: 'Wood panel', absorption: { low: 0.15, mid: 0.11, high: 0.1 }, scatterAmount: 0.4, color: '#8a5a34' },
  { id: 'wool', label: 'Wool felt', absorption: { low: 0.15, mid: 0.65, high: 0.85 }, scatterAmount: 0.55, color: '#d8cfae' },
  { id: 'plastic', label: 'Plastic', absorption: { low: 0.02, mid: 0.03, high: 0.03 }, scatterAmount: 0.1, color: '#d0d3d6' },
  { id: 'smooth-metal', label: 'Smooth metal', absorption: { low: 0.03, mid: 0.03, high: 0.05 }, scatterAmount: 0.05, color: '#b8bcc2' },
  { id: 'uneven-metal', label: 'Corrugated metal', absorption: { low: 0.05, mid: 0.07, high: 0.09 }, scatterAmount: 0.65, color: '#8f9499' },
  { id: 'glass', label: 'Glass', absorption: { low: 0.18, mid: 0.06, high: 0.04 }, scatterAmount: 0.03, color: '#a8d4e0' },
  { id: 'carpet', label: 'Heavy carpet', absorption: { low: 0.08, mid: 0.57, high: 0.71 }, scatterAmount: 0.5, color: '#7a3f4d' },
  { id: 'gypsum-board', label: 'Drywall / gypsum board', absorption: { low: 0.29, mid: 0.1, high: 0.05 }, scatterAmount: 0.2, color: '#e5e1d8' },
  { id: 'acoustic-foam', label: 'Acoustic foam', absorption: { low: 0.15, mid: 0.75, high: 0.92 }, scatterAmount: 0.6, color: '#3a3a3a' },
  { id: 'grass', label: 'Grass', absorption: { low: 0.11, mid: 0.3, high: 0.6 }, scatterAmount: 0.8, color: '#4a7c3f' },
];
